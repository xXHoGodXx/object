...
tail === `org` ? emails.org.push(item.email) : tail === `net` ?  emails.net.push(item.email) : tail === `info` ?  emails.info.push(item.email) :  other.info.push(item.email)
